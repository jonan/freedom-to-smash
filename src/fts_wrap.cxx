...
static int _wrap_PhysicsScene_addPhysicObject(lua_State* L) {
  ...
  SWIG_check_num_args("addPhysicObject",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("addPhysicObject",1,"physics::Scene *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("addPhysicObject",2,"physics::Object &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_physics__Scene,0))){
    SWIG_fail_ptr("PhysicsScene_addPhysicObject",1,SWIGTYPE_p_physics__Scene);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_physics__Object,0))){
    SWIG_fail_ptr("PhysicsScene_addPhysicObject",2,SWIGTYPE_p_physics__Object);
  }
  
  (arg1)->addPhysicObject(*arg2);
...
static int _wrap_PhysicsScene_removePhysicObject(lua_State* L) {
  int SWIG_arg = 0;
  physics::Scene *arg1 = (physics::Scene *) 0 ;
  physics::Object *arg2 = 0 ;
  
  SWIG_check_num_args("removePhysicObject",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("removePhysicObject",1,"physics::Scene *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("removePhysicObject",2,"physics::Object &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_physics__Scene,0))){
    SWIG_fail_ptr("PhysicsScene_removePhysicObject",1,SWIGTYPE_p_physics__Scene);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_physics__Object,0))){
    SWIG_fail_ptr("PhysicsScene_removePhysicObject",2,SWIGTYPE_p_physics__Object);
  }
  
  (arg1)->removePhysicObject(*arg2);
...
static int _wrap_PhysicsScene_getDispatcher(lua_State* L) {
  ...
  result = (btCollisionDispatcher *) &(arg1)->getDispatcher();
...
static int _wrap_PhysicsScene_simulate(lua_State* L) {
  int SWIG_arg = 0;
  physics::Scene *arg1 = (physics::Scene *) 0 ;
  Real *arg2 = 0 ;
  Real temp2 ;
  
  SWIG_check_num_args("simulate",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("simulate",1,"physics::Scene *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("simulate",2,"Real const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_physics__Scene,0))){
    SWIG_fail_ptr("PhysicsScene_simulate",1,SWIGTYPE_p_physics__Scene);
  }
  
  temp2=(Real)lua_tonumber(L,2); arg2=&temp2;
  (arg1)->simulate((Real const &)*arg2);
...
static swig_lua_method swig_physics_Scene_methods[] = {
    ...
    {"simulate", _wrap_PhysicsScene_simulate}, 
    {0,0}
};
...
static int _wrap_new_Character(lua_State* L) {
  ...
  if(!lua_isstring(L,1)) SWIG_fail_arg("Character",1,"String const &");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("Character",2,"Ogre::SceneManager &");
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&arg2,SWIGTYPE_p_Ogre__SceneManager,0))){
    SWIG_fail_ptr("new_Character",2,SWIGTYPE_p_Ogre__SceneManager);
  }
...
static int _wrap_Character_handleScript(lua_State* L) {
  ...
  if(!lua_isstring(L,2)) SWIG_fail_arg("handleScript",2,"String const &");
  ...
  temp2.assign(lua_tostring(L,2),lua_strlen(L,2)); arg2=&temp2;
  (arg1)->handleScript((String const &)*arg2);
